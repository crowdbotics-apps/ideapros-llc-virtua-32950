...
## Project Structure
    ...
    ├── ideapros_llc_virtua_32950  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_virtua_32950`
...
2. Clone this repo and `cd ideapros_llc_virtua_32950`
